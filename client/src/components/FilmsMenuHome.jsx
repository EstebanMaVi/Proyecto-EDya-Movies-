...
import * as styles from '../styles/FilsMenuHome.module.css';
import {datamovies} from '../assets/dajamovies'

export default function FilmsMenuHome() {
